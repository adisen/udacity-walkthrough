...
var getBook = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, book.getBook(id)];
            case 1:
                result = _a.sent();
                return [2 /*return*/, result];
        }
...
var createBook = function (newBook) { return __awaiter(void 0, void 0, void 0, function () {
    var result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, book.createBook(newBook)];
            case 1:
                result = _a.sent();
                return [2 /*return*/, result];
        }
...
var deleteBook = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, book.deleteBook(id)];
            case 1:
                result = _a.sent();
                return [2 /*return*/, result];
        }
